...
<head>
    <meta charset="utf-8"/>
    <title>Tiff Picture preview</title>
...
html += "    <span>";
html += "        Should(tif)File, system parsing error, specific reasons are as follows：";
html += "        <p style=\"color: red;\">document[${file.name}]Parsing failed, please contact the system administrator</p>";
html += "    </span>";
html += "</div>";
html += "</body>";
html += "</html>";
