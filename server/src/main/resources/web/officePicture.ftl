...
<#if "false" == switchDisabled>
    <img src="images/pdf.svg" width="48" height="48" style="position: fixed; cursor: pointer; top: 40%; right: 48px; z-index: 999;" alt="Use PDF preview" title="Use PDF preview" onclick="changePreviewType('pdf')"/>
</#if>
<script>
