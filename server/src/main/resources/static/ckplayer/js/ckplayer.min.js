 ...
 * 开源协议：MIT
 */
(function(global,factory){typeof exports==='object'&&typeof module!=='undefined'?module.exports=factory():typeof define==='function'&&define.amd?define(factory):(global=global||self,global.ckplayer=factory())}(this,function(){'use strict';var language = {
    play: 'Play',
    pause: 'Pause',
    refresh: 'Replay',
    full: 'Fullscreen',
    exitFull: 'Exit Fullscreen',
    webFull: 'Page Fullscreen',
    exitWebFull: 'Exit Page Fullscreen',
    theatre: 'Theatre Mode',
    exitTheatre: 'Exit Theatre Mode',
    volume: 'Volume:',
    muted: 'Muted',
    exitmuted: 'Restore Volume',
    seek: 'Seek:',
    waiting: 'Buffering',
    live: 'Live',
    ...
    smallwindows: 'Small Window Playback',
    playbackrate: 'Playback Speed',
    playbackrateSuffix: 'x',
    track: 'Subtitle',
    noTrack: 'No Subtitle',
    definition: 'Quality',
    switchTo: 'Switch to',
    closeTime: '{seconds} seconds to close the ad',
    closeAd: 'Close Ad',
    second: 'Second',
    details: 'View Details',
    copy: 'Copy',
    copySucceeded: 'Copy succeeded, you can paste!',
    smallwindowsOpen: 'Small window function enabled',
    smallwindowsClose: 'Small window function disabled',
    screenshotStart: 'Taking screenshot, please wait...',
    screenshotClose: 'Screenshot function disabled',
    loopOpen: 'Loop Playback',
    loopClose: 'Loop Playback Disabled',
    close: 'Close',
    down: 'Download',
    p50: '50%',
    p75: '75%',
    p100: '100%',
    timeScheduleAdjust: {
        prohibit: 'Dragging is prohibited for this video',
        prohibitBackOff: 'Rewatching is prohibited for this video',
        prohibitForward: 'Fast-forwarding is prohibited for this video',
        prohibitLookBack: 'Playback of certain parts is prohibited',
        prohibitForwardNotViewed: 'Playing unviewed parts is prohibited',
    },
    error: {
        noMessage: 'Unknown error',
        supportVideoError: 'This browser version is too low; please switch to another browser.',
        videoTypeError: 'This browser does not support playing this video; please switch to another browser.',
        loadingFailed: 'Loading failed',
        emptied: 'An error occurred during video file loading',
        screenshot: 'Screenshot failed',
        ajax: 'Ajax data request error',
        noVideoContainer: 'No container found to place the video',
    },
}
