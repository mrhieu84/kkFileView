...
public class ServerMain {
    ...
    public static void main(String[] args) {
        ...
        logger.info("kkFileView The service startup is completed and takes time:{}s, please visit the demo page: http://127.0.0.1:{} ", stopWatch.getTotalTimeSeconds(), urlSuffix);
    }
